...
BACKUP_SCRIPT_FILE_PATH = os.getenv("BACKUP_SCPRIT_FILE_PATH", '')
BACKUP_SCRIPT_DB_NAME = os.getenv("BACKUP_SCPRIT_DB_NAME", '')
BACKUP_SCRIPT_FTP_ADDRESS = os.getenv("BACKUP_SCPRIT_FTP_ADDRESS", '')
BACKUP_SCRIPT_FTP_USER = os.getenv("BACKUP_SCPRIT_FTP_USER", '')
