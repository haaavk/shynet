...
class JSONEditorWidget(forms.Widget):
    class Media:
        js = (getattr(settings, "JSON_EDITOR_JS", "shydb/jsoneditor.min.js"),)
        css = {
            "all": (getattr(settings, "JSON_EDITOR_CSS", "shydb/jsoneditor.min.css"),)
        }

    template_name = "shydb/django_json_widget.html"
